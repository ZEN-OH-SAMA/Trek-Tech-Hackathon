...
def send():
	...
	elif (user == "admission" or user == "Admission related enquiries" or user == "hiiii"):
	...
	elif (user == "emergency" or user == "Where should I contact during emergencies" or user == "have you something"):
		txt.insert(END, "\n" + "Bot: In case of Emergency services immediately call for \n * Campus security- 022-27541005\n* Police Helpline- 100\n* Ambulance- 102,108\n* Fire Helpline- 101")

	elif (user == "recruiters" or user == "What are major recruiters of college" or user == "crack a funny line"):
		txt.insert(
